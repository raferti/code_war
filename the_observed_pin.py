...
Alright, detective, one of our colleagues successfully observed our target
 ...
 warehouse is secured by an electronic combination lock.
...
function, that returns an array (or a list in Java and C#) of all
variations for an observed PIN with a length of 1 to 8 digits.
